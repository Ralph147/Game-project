...
class Character:
    def __init__(self, Name,raceName,className, Weapon, Level, Damage, Health, Heal):
        self._Name = Name
        self._Race = raceName
...
class Weapon:
    def __init__(self,Weapon,weaponType,Damage):
        self._Weapon = Weapon
    ...
    def setDamage(self,Weapon,weaponType,Damage):
        if weaponType == 1 and Weapon == 'Sword':
...
weaponInfo = Weapon(Weapon,weaponType,Damage)
Player = Character(Name,raceInfo.getRace(),classInfo.getClass(),weaponInfo.getWeapon(),Level,weaponInfo.getDamage(),Health,Heal)
def Stats():
    print("##############################")
    print("##        STATS             ##")
    print("##############################")
...
print("You set off on your journey, to face Ragnaros, Bringer of the end, and finally bring peace to the world.")
print("However each round you spend defeating his minions Ragnaros grows stronger")
replay = True
while replay == True:
    if Player.getLevel() == 10:
